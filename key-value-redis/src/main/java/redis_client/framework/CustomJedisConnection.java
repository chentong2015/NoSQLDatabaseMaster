...
public class CustomJedisConnection {
    ...
    public CustomJedisConnection(String host, short port) {
        this.host = host;
        this.port = port;
    }
    ...
    public CustomJedisConnection sendCommand(RedisCommand command, String... input) throws IOException {
        connectRedisServer();
